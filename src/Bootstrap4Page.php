 ...
 * @author muellerm
 */
class Bootstrap4Page implements \Qck\Interfaces\Output
{
    ...
    public function render()
    {
        ...
        <?= $this->HeaderContents ? $this->HeaderContents->renderHtml() : "" ?>
            </head>
            <body>
                <?= $this->Contents->renderHtml(); ?>
        ...
        <?php if ($this->UseJs): ?>
                ...
                <?php endif; ?>                
        <?= $this->FooterContents ? $this->FooterContents->renderHtml() : "" ?>
            </body>
        </html>
        <?php
        return ob_get_clean();
