...
abstract class Expression implements \qck\db\interfaces\Expression
{
  ...
  //abstract function toSql( SqlDialect $SqlDialect, array &$Params=[] );
  ...
  static function gt( ValueExpression $LeftOperand,
                      ValueExpression $RightOperand )
  {
    return new Greater( $LeftOperand, $RightOperand );
  }

  static function ge( ValueExpression $LeftOperand,
                      ValueExpression $RightOperand )
  {
    return new GreaterEquals( $LeftOperand, $RightOperand );
  }

  static function eq( ValueExpression $LeftOperand,
                      ValueExpression $RightOperand )
  {
  ...
  static function lt( ValueExpression $LeftOperand,
                      ValueExpression $RightOperand )
  {
    return new Less( $LeftOperand, $RightOperand );
  }

  static function le( ValueExpression $LeftOperand,
                      ValueExpression $RightOperand )
  {
